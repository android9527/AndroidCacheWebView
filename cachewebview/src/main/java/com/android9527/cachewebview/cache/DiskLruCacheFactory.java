...
/**
 * Creates an {@link com.android9527.cachewebview.cache.diskcache.DiskLruCache} based disk cache in the specified
 * disk cache directory.
 *
 * <p>If you need to make I/O access before returning the cache directory use the {@link
 * #DiskLruCacheFactory(CacheDirectoryGetter, int)} constructor variant.
 */
